...
class OsPanelController extends Controller {
    ...
    public function index()
    {
        ...
        if(Auth::user()->type != 'tecnico') {
            ...
            $body 	= 'ospanel';
            return view('ospanel.indexadmin', compact('title','body', 'installs', 'canceladas', 'asignadas', 'completadas', 'procesos', 'reprogramadas', 'confirmadas'));
        } else {
            ...
            $title 	= 'OsPanel | Ordenes de Servicio';
            $body 	= 'ospanel';
            return view('ospanel.indexuser', compact('title','body', 'installs'));
