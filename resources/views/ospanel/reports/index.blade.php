        ...
        <div class="col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body text-center">
                    <a class="btn btn-success btn-lg" href="{{ url('/ospanel/installs/create') }}">Nueva instalación</a>
                    <a class="btn btn-success btn-lg" href="{{ url('/ospanel/installs') }}">Listar instalaciones</a><br>
                    @role('admin')
                    eres admin
                    @endrole
                    @role('contralor')
