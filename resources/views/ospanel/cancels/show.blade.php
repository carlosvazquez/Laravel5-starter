...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-xs-12">{!! link_to_route('ospanel.installs.show', $title = 'Regresar', $parameters = array('id' => $data->install_id), $attributes = array('class'=>'btn btn-success btn-lg', 'aria-label'=>'Left Align"')) !!}</div>
    </div>
</div>
@endsection